              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Text(
                      'Atur keuanganmu dengan lebih mudah dan efektif dengan fitur cerdas dari Savelt.',
                      textAlign: TextAlign.center,
                          ...
                          children: List.generate(5, (index) {
                            return Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                color: index == 0 ? Colors.white : Colors.transparent, // Lingkaran ke-4 berisi warna
                                border: Border.all(color: Colors.white, width: 2),
                              ),
                            );
                          }),
                        ),
                        // Tombol Kanan (→) ke SplashScreen2
                        IconButton(
                          onPressed: () {
                            Navigator.push(
                              context,
